...
<body>
	...
	<div id="tabs">
		...
		<div id="tabs-1">
			<div id="dialog-form" title="Agregar usuario">
		...
		<br>
			...
			<div id="dialog-form" title="Agregar equipo">
			    ...
			    <fieldset>
			        ...
			        <input type="text" name="j1" id="j1" value="" class="text ui-widget-content ui-corner-all" /><br>
			        <label for="j2">Jugador 2</label>
			        <input type="text" name="j2" id="j2" value="" class="text ui-widget-content ui-corner-all" /><br>
			        <label for="j3">Jugador 3</label>
			        <input type="text" name="j3" id="j3" value="" class="text ui-widget-content ui-corner-all" /><br>
			        <label for="j4">Jugador 4</label>
			        <input type="text" name="j4" id="j4" value="" class="text ui-widget-content ui-corner-all" /><br>
			        <label for="j5">Jugador 5</label>
			        <input type="text" name="j5" id="j5" value="" class="text ui-widget-content ui-corner-all" />
			    </fieldset>
			    </form>
			</div>
		</div>
