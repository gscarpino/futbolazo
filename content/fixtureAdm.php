...
// 	$client->setApplicationName("El Futbolazo");
	
// 	// Visit https://code.google.com/apis/console?api=calendar to generate your
// 	// client id, client secret, and to register your redirect uri.
// 	$client->setClientId('43174258421.apps.googleusercontent.com');
// 	$client->setClientSecret('_fV3YpuYByt_VNV_p-j7jZIy');
// 	$client->setRedirectUri('http://localhost/futbolazo/content/fixtureAdm.php');
// 	$client->setDeveloperKey('43174258421@developer.gserviceaccount.com');
...
<body>
	...
	<div id="tabs">
		...
		<br>
		<form action="fixtureAdm.php?accion=agFecha" method="post">
				...
				if(isset($_GET['accion'])){
					...
					if($accion == "agFecha"){
						...
						if($equipo1 == $equipo2){
							...
							$fecha = $_POST['fecha'];
							$hora = $_POST['hora'];
							if(agregarPartido($equipo1,$equipo2,$fecha,$hora,$comentario)){
								displayGreen("","Partido agregado con exito");
// 								$event = new Google_Event();
// 								$event->setSummary('Appointment');
// 								$event->setLocation('Somewhere');
// 								$start = new Google_EventDateTime();
// 								$start->setDateTime('2013-02-03T10:00:00.000-07:00');
// 								$event->setStart($start);
// 								$end = new Google_EventDateTime();
// 								$end->setDateTime('2011-02-04T10:25:00.000-07:00');
// 								$event->setEnd($end);
...
// 								$createdEvent = $client->events->insert('primary', $event);
							}
							else{
					...
					if(isset($_GET['num'])){
						...
						if($accion == "suspenderPartido"){
							...
							<form action="fixtureAdm.php?accion=suspenderPartido2&num=' . $num . '" method="post">
						...
						if($accion == "cancelarPartido"){
							...
							<form action="fixtureAdm.php?accion=cancelarPartido2&num=' . $num . '" method="post">
